...
interface PowerUpsProps {
  ...
  onRotateHand: () => void;
  onRefreshHand: () => void;
  onBombPointerDown: (e: React.PointerEvent<HTMLButtonElement>) => void;
    ...
    >
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className={`flex flex-col items-center gap-1 p-2 rounded-xl border transition-all relative w-[76px] h-[52px] justify-center ${
        ...
        >
          ...
          <span className="text-[9px] font-sans text-neutral-400">Rotate</span>
        </button>
        ...
        >
          ...
          <span className="text-[9px] font-sans text-neutral-400">Reroll</span>
        </button>
        ...
        <button
          ...
          title="Drag 3x3 Grid Bomb (Cost: 200)"
          style={{ touchAction: 'none' }}
        >
          <div className="flex items-center gap-1 text-[11px] font-semibold leading-none pointer-events-none">
            <Bomb className="w-4 h-4 text-red-400" />
            <span className="font-mono">{bombCost}</span>
          </div>
          <span className="text-[9px] font-sans text-neutral-400 pointer-events-none">
            {activePowerUp === 'bomb' ? 'Active' : 'Bomb'}
          </span>
        </button>
      </div>
    </div>
